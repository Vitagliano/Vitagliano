  ...
  return (
    <Card>
      ...
      <div className="mt-4 text-gray-400 mb-8 flex gap-4 flex-col">
        <p>I&apos;m 27 years old and based in São Paulo, Brazil.</p>
        <p>
          ...
          user-friendly pages and making sure every project is visually appealing
          and easy to use.
        </p>
        <p>
        Lately, I&apos;ve been passionate about web3, building seamless experiences that connect traditional and decentralized platforms.
        </p>
      </div>
